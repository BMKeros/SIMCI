...
class Catalogo extends Eloquent{
	...
	protected $visible = array('id','nombre', 'descripcion', 'especificaciones', 'cod_unidad', 'cod_tipo_objeto','data_unidad','data_tipo_objeto');
	...
	public function tipoObjeto(){
		return $this->belongsTo('TipoObjeto','cod_tipo_objeto');
	}
    ...
    public function getDataTipoObjetoAttribute()
    {
        return $this->tipoObjeto;
    }

    protected $appends = array('data_unidad', 'data_tipo_objeto');
}
