    ...
    <div class="content">
        <table class="ui celled table capitalize">
            ...
            <tr>
                <td colspan="2">
                    <b>Responsable:</b><br>
                    <p><% data_almacen.nombre_responsable +' '+ data_almacen.apellido_responsable + ' ' + '(' +
                        data_almacen.usuario + ')' %></p>
                </td>
                <td colspan="2">
                    <b>Primer auxiliar:</b><br>
                    <p><% data_almacen.nombre_primer_auxiliar +' '+ data_almacen.apellido_primer_auxiliar + ' ' + '(' +
                        data_almacen.usuario + ')'%></p>
                </td>

                <td colspan="2">
                    <b>Segundo auxiliar:</b><br>
                    <p ng-if="data_almacen.nombre_segundo_auxiliar && data_almacen.apellido_segundo_auxiliar">
                        <% data_almacen.nombre_segundo_auxiliar +' '+ data_almacen.apellido_segundo_auxiliar + ' ' + '('
                        + data_almacen.usuario + ')'%>
                    </p>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <b>Creado:</b><br>
                    <p><% data_almacen.created_at | formato_timestamps %></p>
                </td>
                <td colspan="3">
                    <b>Actualizado:</b><br>
                    <p><% data_almacen.updated_at | formato_timestamps %></p>
                </td>
            </tr>
