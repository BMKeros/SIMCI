...
<div class="ui two column doubling stackable grid container">
    <div class="ui container centered grid">
        <div class="column">
            <table class="ui selectable celled table capitalize" datatable="" dt-options="opciones_tabla_usuarios"
                   dt-columns="columnas_tabla_usuarios" dt-instance='tabla_usuarios' width="100%"></table>
        </div>
    </div>
</div>
    ...
    <div class="content">
        <table class="ui celled table">
            ...
            <tr>
                <td colspan="4">
                    <b>Creado:</b><br>
                    <p><% data_usuario.created_at | formato_timestamps %></p>
                </td>
                <td colspan="4">
                    <b>Actualizado:</b><br>
                    <p><% data_usuario.updated_at | formato_timestamps %></p>
                </td>
            </tr>
            </tbody>
        </table>
                    ...
                    <div class="two fields">
                        ...
                        <div class="two field">
                            ...
                            <input type="text" name="segundo_apellido" placeholder="Segundo Apellido"
                                   ng-model="DatosForm.segundo_apellido">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="two fields">
                        ...
                        <div class="two field">
                            ...
                            <input type="text" name="fecha_nacimiento" id="fecha_nacimiento"
                                   placeholder="Fecha Nacimieto" ng-model="DatosForm.fecha_nacimiento">
                        </div>
                    </div>
                </div>
