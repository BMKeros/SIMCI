...
<div class="ui two column doubling stackable grid container">
    <div class="ui container centered grid">
        <div class="column">
            <table class="ui selectable celled table capitalize" datatable="" dt-options="opciones_tabla_laboratorios"
                   dt-columns="columnas_tabla_laboratorios" dt-instance='tabla_laboratorios' width="100%"></table>
        </div>
    </div>
</div>
                ...
                <div class="field">
                    <div class=" two fields">
                        <div class="field">
                            ...
                            <input type="text" name="nombre" placeholder="Nombre del Laboratorio"
                                   ng-model="DatosForm.nombre">
                        </div>
                    </div>
                </div>
                <br>
                <div class="field">
                    <div class="nine wide field ui form">
                        <div class="field">
                            ...
                            <textarea name="descripcion" placeholder="Descripcion de Laboratorio"
