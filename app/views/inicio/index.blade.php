...
<head>
    ...
    <title>Seapamc | Aula Virtual</title>
    <!-- core CSS -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#features">Somos nosotros</a></li>
                        <li class="scroll"><a href="#portfolio">Galerias</a></li>
                        <li class="scroll"><a href="#services">Cursos</a></li>
                       <!-- <li class="scroll"><a href="#about">About</a></li>-->
                        <!--<li class="scroll"><a href="#meet-team">Team</a></li>
                        <li class="scroll"><a href="#pricing">Pricing</a></li>-->
                        <li class="scroll"><a href="#blog">Diplomados</a></li>                         
   ...
   <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Seapamc</h2>
                <p class="text-center wow fadeInDown">Aqui Va mision, Vision Objetivos. <br> Toda la informacion </p>
            </div>
            <div class="row">
...
<section id="portfolio">
    ...
    <section id="services" >
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Cursos Disponibles</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Asistente  contable</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Redaccion de Documentos Juridicos</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Asistente penal</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Seguridad Industrial y Permisos de Trabajo</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                     ...
                     <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Gerencia de Mantenimiento Mecanica</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                     ...
                     <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Reparacion de Mantenimientos de Computadoras <br> (Mauroa y Dabajuro)</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                     ...
                     <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Reparacion de Mantenimientos de Celulares <br> (Mauroa y Dabajuro)</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Asistente Juridico</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Inspector de Obras Civiles</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Instrumentacion para la industria</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Inspector SMA</h4>
                                <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                            </div>
                        </div>
                    </div><!--/.col-md-4-->
   ...
   <!-- <section id="about">
    ...
    <section id="blog">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Diplomados</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
        ...
        <!--div class="row">
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                <div class="media service-box">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Gerencia integral en RRHH</h4>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                    </div>
                </div>
            </div><!--/.col-md-4-->
             ...
             <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                <div class="media service-box">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Gerencia en Seguridad Industrial</h4>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                    </div>
                </div>
            </div><!--/.col-md-4-->
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                <div class="media service-box">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Gerencia en Didactica y Pedagogia</h4>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                    </div>
                </div>
            </div><!--/.col-md-4-->
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                <div class="media service-box">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Gerencia en Tecnicas Deportivas y Recreativas</h4>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                    </div>
                </div>
            </div><!--/.col-md-4-->
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                <div class="media service-box">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Gerencia en Investigacion Educativa</h4>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                    </div>
                </div>
            </div><!--/.col-md-4-->
    ...
    <section id="get-in-touch">
        <div class="container">
                <div class="section-header">
                    ...
                    <p class="text-center wow fadeInDown"> Direccion Coro: <br> Liceo Bolivariano "Cesar Augusto Agreda" <br> Sector Bobare, Av. Pinto Salinas, Al lado de Poli-Coro <br>
                    Direccion Cumarebo: <br> Escuela Bolivariana "Manuel Vicente |Preguntar|".  Calle |Preguntar|</p>
                </div>
            </div>

            <div class="container">
                <div class="section-header">
                    <h2 class="section-title text-center wow fadeInDown">Otras Extenciones</h2>
                    <p class="text-center wow fadeInDown"> Direccion Dabajuro:<br> Escuela Basica "Guillermo De Leon". Dia: Sabado en Horario  de 8:00am a 1:00pm</p>
                    <p class="text-center wow fadeInDown"> Direccion Mene Mauroa:<br> Escuela Bolivariana "Los Cortijos de Lourdes". Dia: Viernes en Horario  de 3:00pm a 6:00pm</p>
                </div>
            </div>
        ...
        <section id="work-process">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title text-center wow fadeInDown">Requisitos</h2>
                    <p class="text-center wow fadeInDown"> 1 Fotocopia de la Cedula <br> Mayores de 14 anos <br> <strong> Para Diplomados:</strong> <br> 1 Fotocopia de la Cedula <br> 1 Foto tipo Carnet <br> Tener minimo un 2do semestre en cualquier carrera universitaria.</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <div class="contact-form">
                            ...
                            <address>
                              <strong>Coro Estado Falcon</strong><br>
                              <abbr title="Phone">Tlfn:</abbr><br> 0414-165-5309 /
                              0412-076-0552 / 
                              0416-264-6469<br>
                              <abbr title="number">BBM:</abbr> 56408441 / 
                              567BDE40</br>
                            </address>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"> Seapamc Miranda   </i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="#"><i class="fa fa-hotmail"></i></a></li>
                        <li><a href="#"><i class="fa fa-google-plus"> seapamc@hotmail.com</i></a></li>
                    </ul>
                </div>
            </div>
        </div>
