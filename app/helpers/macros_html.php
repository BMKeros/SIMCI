...
Form::macro('select_permisos', function($atributos = null){
	if($atributos){
		...
		$html = sprintf('<select multiple="" %s ng-model="DatosForm.usuario.permisos">',atributos_dinamicos($atributos,$default_values));
...
Form::macro('select_sexo', function($atributos = null){
	...
	if($atributos){
		...
		$html = sprintf('<select %s ng-model="DatosForm.persona.sexo">', atributos_dinamicos($atributos, $default_values));
...
Form::macro('select_tipo_usuario', function($atributos = null){
	...
	if($atributos){
		...
		$html = sprintf('<select %s ng-model="DatosForm.usuario.tipo_usuario">', atributos_dinamicos($atributos,$default_values));
