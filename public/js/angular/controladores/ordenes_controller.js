...
(function () {
    ...
    function OrdenesController($scope, $http, $filter, $timeout, $route, $routeParams, $location, DTOptionsBuilder, DTColumnBuilder, $compile, ToolsService, $templateCache, $window, ngAudio, CONSTANTES) {
        ...
        if ($location.$$url == '/ordenes/ver/todos') {
            ...
            $scope.opciones_tabla_ordenes = DTOptionsBuilder.newOptions()
                ...
                .withOption('createdRow', function (row, data) {
                    ...
                    var clase_celda = ToolsService.get_class_status_orden(data.status);
                    //Asignamos la clase
            ...
            $scope.columnas_tabla_ordenes = [
                ...
                DTColumnBuilder.newColumn(null).withTitle('Acciones').renderWith(
                    function (data, type, full) {
                        ...
                        var html = '<div class="ui blue buttons">';
