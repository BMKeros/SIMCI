...
(function () {
    ...
    LaboratorioController.$injector = [
        '$scope',
        '$http',
        '$log',
        '$timeout',
    ...
    function LaboratorioController($scope, $http, $log, $timeout, $route, $routeParams, $location, DTOptionsBuilder, DTColumnBuilder, $compile, ToolsService, $templateCache, $filter) {
