...
(function () {
    ...
    function InventarioController($scope, $http, $log, $timeout, $route, $routeParams, $location, $compile, DTOptionsBuilder, DTColumnBuilder, ToolsService, $templateCache) {
